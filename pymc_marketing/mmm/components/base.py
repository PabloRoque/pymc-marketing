...
class SerializableMixin:
    ...
    - **to_dict()**: Serializes to wrapped format with class name and data
    ...
    def to_dict(self) -> dict[str, Any]:
        """Serialize to dictionary with class wrapper.

        Wraps the Pydantic model_dump output with the class name for
        polymorphic deserialization support. This format is required for
        all serialization and enables proper type resolution when loading
        models with different transformation implementations.
    ...
    def serialize_prior(value: Any) -> Any:
        ...
        Helper method for custom field_serializers that need to handle Prior objects.
